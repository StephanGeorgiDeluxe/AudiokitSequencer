...
let bassDrumFile = try AKAudioFile(readFileName: "Samples/Drums/bd01.wav")
let clapFile = try AKAudioFile(readFileName: "Samples/Drums/cp01.wav")
let closedHiHatFile = try AKAudioFile(readFileName: "Samples/Drums/hh01.wav")
let hiTomFile = try AKAudioFile(readFileName: "Samples/Drums/ht01.wav")
let loTomFile = try AKAudioFile(readFileName: "Samples/Drums/lt01.wav")
let midTomFile = try AKAudioFile(readFileName: "Samples/Drums/mt01.wav")
let openHiHatFile = try AKAudioFile(readFileName: "Samples/Drums/oh.wav")
let snareDrumFile = try AKAudioFile(readFileName: "Samples/Drums/sd0    1.wav")
